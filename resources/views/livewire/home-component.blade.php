...
<div>
    ...
    <main>
            ...
            <div class="container d-lg-flex">
                <div class="about_main">
                    <div class="wrapper">
                        ...
                        <h2 class="about_main-title type" data-text="{{ $home->aboutus_title }}">
                            {{ $home->aboutus_title }}
                        </h2>
                    </div>
            ...
            <div class="container d-flex flex-column-reverse flex-xl-row">
                <ul class="index-services_list no-styled">
                    <div class="title-wrapper container text-right">
                        ...
                        <h2 class="about_main-title type" data-text="{{ $home->services_title }}">
                            {{ $home->services_title }}
                        </h2>
                    </div>
                    @php
                    ...
                    <li class="wrapper" >
                        <a class="index-services_list-item d-flex flex-column" data-aos="fade-up" data-aos-delay="{{ $latency++}}00" href="{{ route('services') }}#service{{ $latency++}}">
        ...
        <section class="projects">
            <div class="container">
                <div class="wrapper text-center">
                    ...
                    <h2 class="about_main-title type text-center" data-text="{{ $home->projects_title }}">
                        {{ $home->projects_title }}
                    </h2>
                </div>
                ...
                <div class="projects_wrapper">
                    ...
                    <div class="projects_controls">
                        <div class="swiper-btn swiper-button-prev"><i class="icon-angle-left icon"></i></div>
                        <div class="swiper-btn swiper-button-next"><i class="icon-angle-right icon"></i></div>
                    </div>
                </div>
        ...
        <div class="faq">
            <div class="container">
                <div class="accordion" id="faq_accordion">
                    ...
                    <div class="accordion-item @if ($loop->first) active @endif" wire:key='{{ $faq->id }}'>
                        <h3 class="title d-flex justify-content-between align-items-center accordion-header">
                        {{ $faq->question }}
                            <span class="title_icon @if($loop->first) transform @endif">
                                <i class="icon-arrow-left icon arrow-rotate"></i>
                            </span>
                        </h3>
                        <div id="item{{ $faq->id }}" class="accordion-content">
                            <div class="body">
                                <div class="main">
                                    {!! $faq->answer !!}
                                </div>
        ...
        <section class="testimonials section">
            <div class="container">
                <h2 class="testimonials_header">{{ $home->testimonials_title }}</h2>
                
                <div class="testimonials_wrapper">
                    <div class="testimonials_controls d-flex">
                        <div class="testimonials_controls-control swiper-button-prev">
                            <i class="icon-angle-left icon"></i>
                        </div>
                        <div class="testimonials_controls-control swiper-button-next">
                ...
                <div class="feedback_main">
                    <div class="feedback_main-header">
                        <div class="wrapper">
                            ...
                            <h2 class="feedback_main-header_title type" data-text="{{ $home->askus_title }}">{{ $home->askus_title }}</h2>
                        </div>
