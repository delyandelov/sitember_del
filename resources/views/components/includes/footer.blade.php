    ...
    <div class="container">
        <div class="footer_top">
            <a class="logo footer_top-logo d-inline-flex align-items-center" href="/">
                ...
                <span class="logo_text h2">Sitember</span>
            </a>
        ...
        <div class="footer_bottom">
            <div class="footer_bottom-contacts d-flex flex-column">
                <a class="link" href="mailto:example@domain.com">info@sitember.com</a>
                <a class="link" href="tel:+1234567890">+359 899 333 444</a>
            </div>
        ...
        <p class="footer_copyright">Copyright &copy; <span id="currentYear"></span> Sitember</p>
    </div>
